                        ...
                        <div class="messages__sidebar c-overflow">
                            ...
                            <div class="list-group">
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Davil Parnell</div>
                                        <small class="list-group__text">Fierent fastidii recteque ad pro</small>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Ann Watkinson</div>
                                        <small class="list-group__text">Cum sociis natoque penatibus </small>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Marse Walter</div>
                                        <small class="list-group__text">Suspendisse sapien ligula</small>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Jeremy Robbins</div>
                                        <small class="list-group__text">Phasellus porttitor tellus nec</small>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Reginald Horace</div>
                                        <small class="list-group__text">Quisque consequat arcu eget</small>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Shark Henry</div>
                                        <small class="list-group__text">Nam lobortis odio et leo maximu</small>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Paul Van Dack</div>
                                        <small class="list-group__text">Nam posuere purus sed velit auctor sodales</small>
                                    </div>
                                </a>

                                <a class="list-group-item media" href="">
                                    <div class="pull-left">
                                        <img src="demo/img/profile-pics/1.jpg" alt="" class="avatar-img">
                                    </div>
                                    <div class="media-body">
                                        <div class="list-group__heading">James Anderson</div>
                                        <small class="list-group__text">Vivamus imperdiet sagittis quam</small>
                                    </div>
                                </a>
                                ...
                                <a class="list-group-item media" href="">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group__heading">Kane Williams</div>
                                        <small class="list-group__text">Suspendisse justo nulla luctus nec</small>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="messages__body">
                            <div class="action-header">
                                <div class="action-header__label">
                                    ...
                                    <span class="hidden-xs">Sarah Corner</span>
                                </div>

                                <div class="action-header__search">
                                    <input type="text" placeholder="Start typing..." class="action-header__input">
                                    <i class="action-header__close zmdi zmdi-long-arrow-left" data-mae-action="action-header-close"></i>
                                </div>

                                <div class="actions action-header__actions">
                                    <a href="" class="action-header__toggle"><i class="zmdi zmdi-search"></i></a>
                                    <a href="" class="hidden-xs"><i class="zmdi zmdi-time"></i></a>
                                    ...
                                    <a href="" class="hidden-xs"><i class="zmdi zmdi-info"></i></a>
                            ...
                            <div class="list-group">
                                <div class="list-group-item media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <small class="messages__date"><i class="zmdi zmdi-time"></i> 20/02/2015 at 09:00</small>
                                    </div>
                                </div>

                                <div class="list-group-item media">
                                    <div class="pull-right">
                                        <img class="avatar-img" src="demo/img/profile-pics/8.jpg" alt="">
                                    </div>
                                    <div class="media-body">
                                        <div>
                                            <div class="messages__item">
